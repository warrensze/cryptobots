...
try:
    while robot.distance() < 1874: # Drive for mm
        ...
        target_angle = -1 * (-4.17 + 0.228*x + -1.25E-03*x**2 + 1.63E-06*x**3 + -6.42E-10*x**4 + -3.65E-14*x**5 + 4.75E-17*x**6)  # left then right curve
        fit_R2 = 0.969  # Assuming a perfect fit for simplicity
